...
//2014-06-23 ueda
- (void)setMessageString:(NSString*)messageString fontOfSize:(int)fontSize
{
    self.messageLabel.hidden = !messageString;
    self.messageLabel.text = messageString;
    self.messageLabel.font = [UIFont systemFontOfSize:fontSize];
}
...
- (void)show
{
  ...
  [window makeKeyAndVisible];
    //2015-11-02 ueda Xcode7&iOS9の場合に背景が真っ黒になるのを防ぐ
  ...
  [UIView animateWithDuration:0.05
                   ...
                   completion:nil];
    //2016-04-08 ueda
    NSLog(@"*** SSGentleAlertView Show.");
    AppDelegate* appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
    appDelegate.isDisplayAlert = YES;
    CustomWindow *cw = (CustomWindow*)appDelegate.window;
    [cw setExpireTimerSecond:[[System sharedInstance].notOpeCheckSecAlert floatValue]];
}
...
- (void)remove
{
  ...
  [UIView animateWithDuration:0.05
    ...
    //2016-04-08 ueda
    NSLog(@"*** SSGentleAlertView Closed.");
    AppDelegate* appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
    appDelegate.isDisplayAlert = NO;
    CustomWindow *cw = (CustomWindow*)appDelegate.window;
    [cw setExpireTimerSecond:[[System sharedInstance].notOpeCheckSecNormal floatValue]];
}
